# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-11-07 10:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cabinet_order', models.CharField(blank=True, max_length=30, null=True, verbose_name='机位号')),
                ('floor', models.IntegerField(blank=True, default=1, max_length=30, null=True, verbose_name='楼层')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watch_tel', models.CharField(max_length=11, verbose_name='值班电话')),
                ('manager', models.CharField(max_length=32, verbose_name='值班经理')),
                ('manager_tel', models.CharField(max_length=11, verbose_name='经理电话')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menus', models.ManyToManyField(to='repository.Menu')),
                ('permission', models.ManyToManyField(to='repository.Permission')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ilo_ip', models.GenericIPAddressField(blank=True, null=True, verbose_name='管理IP')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, '正常'), (1, '禁用')])),
        ...
        migrations.AddField(
            ...
            name='contact',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='c', to='repository.Role', verbose_name='业务联系人'),
        ),
        migrations.AddField(
